...
word_translations = {
    ...
    "body": "身体", "leg": "腿", "foot": "脚",
    # 动物
    "duck": "鸭子", "pig": "猪", "cat": "猫", "bear": "熊",
    "dog": "狗", "bird": "鸟", "panda": "熊猫", "monkey": "猴子",
    "tiger": "老虎", "zoo": "动物园", "elephant": "大象",
    # 食物
    ...
    "old": "旧的", "young": "年轻的", "good": "好的", "bad": "坏的",
    "better": "更好的", "best": "最好的", "happy": "快乐的",
    "sad": "悲伤的", "angry": "生气的", "tired": "累的",
    "hungry": "饿的", "thirsty": "渴的", "sick": "生病的",
    "fine": "好的", "well": "好", "nice": "美好的", "great": "伟大的",
    "wonderful": "精彩的", "beautiful": "美丽的", "ugly": "丑陋的",
...
def translate_sentence(example):
    ...
    if example.startswith('I have a ') or example.startswith('I have an '):
        obj = example.split('I have ')[1][2:-1]  # 去掉 "a/an " 和 "."
